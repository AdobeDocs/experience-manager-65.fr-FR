...
1. [Objectifs et paramètres](#settingsgoalssettingsconfiguringtheactivityandsettinggoals) : planifiez l’activité et définissez la priorité. Vous pouvez également définir des objectifs de mesures de réussite.
...
1. Par défaut, aucun ID d’emplacement n’est défini. Cliquez ou appuyez sur Configurer (icône d’engrenage) pour définir l’emplacement.
   ...
   Pour demander aux utilisateurs d’entrer un emplacement, cochez la case **Forcer l’emplacement **.
