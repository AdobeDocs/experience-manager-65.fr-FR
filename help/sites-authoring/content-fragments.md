...
Les fragments de contenu d’Adobe Experience Manager (AEM) [sont créés et gérés sous forme de ressources indépendantes de la page](/help/assets/content-fragments.md).
...
1. Vous pouvez :
   ...
   * Open the **Assets** browser and filter for **Content Fragments** (the default is Images). Faites ensuite glisser le fragment en question sur l’instance du composant.
...
1. Initially the content from the **Main** Element and **Master** (variation) will be shown. Vous pouvez [sélectionner d’autres éléments et/ou variantes](#selecting-the-element-or-variation) en fonction de vos besoins.
...
Vous pouvez ouvrir la source du fragment à modifier (la ressource) à l’aide de l’icône **Edition** située dans la barre d’outils du composant. Vous pourrez ainsi [modifier et gérer le fragment de contenu](/help/assets/content-fragments.md). 
...
Cela permet d’ajouter du contenu supplémentaire [à l’intérieur (c’est-à-dire au niveau intermédiaire)](/help/assets/content-fragments.md#inbetweencontent) du contenu du fragment (au niveau de tout point disponible), sans avoir à modifier le fragment racine.
...
Si vous avez [associé du contenu](/help/assets/content-fragments-assoc-content.md) au [fragment de contenu](/help/assets/content-fragments.md), ces ressources sont disponibles à partir du sidekick (une fois que vous avez placé votre fragment sur la page de contenu). Le contenu associé est en fait une source spéciale de [contenu intermédiaire](#adding-in-between-content).
...
* Un fragment peut être publié une fois [qu’il a été créé dans la console Ressources](/help/assets/content-fragments.md#publishingandreferencingafragment).
