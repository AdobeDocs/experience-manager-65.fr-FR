  ...
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>groupe project-administrators (pour pouvoir créer un projet et déplacer des ressources)</li>
    </ul> </td>
  </tr>
 </tbody>
</table>
