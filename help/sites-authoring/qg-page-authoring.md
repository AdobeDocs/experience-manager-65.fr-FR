...
Pour [créer une nouvelle page](/help/sites-authoring/managing-pages.md#creating-a-new-page) :
...
1. [Ouvrez la page pour modification](/help/sites-authoring/managing-pages.md#opening-a-page-for-editing) à l’aide de l’icône Modifier (crayon) :
   ...
   * Dans la barre d’outils [une fois la page sélectionnée](#selectiingyourpageforfurtheraction).
...
[Verrouillez une page](/help/sites-authoring/editing-content.md#locking-a-page) pour empêcher d’autres auteurs de la modifier en même temps que vous. L’icône/le bouton Verrouiller (et Déverrouiller) est accessible :
