...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>(GRANITE-63681) L’authentification des connecteurs de modèle de données de formulaire peut échouer, car les mots-clés et le modèle RegEx requis ne sont pas autorisés par défaut.</li>
    </ul>
    </td>
  </tr>
    <tr>
