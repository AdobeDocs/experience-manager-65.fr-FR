...
<table>
  ...
  <tr>
    <td>
      ...
      <em>S’applique à : </em> AEM 6.5.25.0 les déploiements WAR/JEE (y compris AEM Forms sur JEE)<br>
    </td>
    <td>
    <ul>
