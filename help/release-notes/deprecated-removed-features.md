...
| Foundation | Framework de déchargement Granite Adobe n’envisage pas d’apporter d’autres améliorations au framework de déchargement ajouté à la version CQ 5.6.1 pour externaliser le traitement des ressources. | Adobe travaille sur une structure de déchargement native pour le cloud de nouvelle génération. |  |
...
| Développeurs | Bibliothèque cliente Handlebars. Adobe ne prévoit pas de gérer ni de mettre à jour la bibliothèque cliente Handlebar fournie avec la distribution (Quickstart).. | Adobe recommande les clients qui nécessitent encore `Handlebars` pour leur code afin de l’ajouter à leur base de code de projet. |  |
...
| Développeurs | Éditeur de boîte de dialogue de l’interface utilisateur classique en CRXDE Lite. Adobe ne prévoit pas d’améliorer l’éditeur de boîte de dialogue pour l’interface utilisateur classique fourni avec la distribution (Quickstart). | Aucun remplacement n’est disponible. |  |
| Forms | L’intégration d’AEM Forms à AEM Mobile est obsolète. | Aucun remplacement n’est disponible. |  | Développeurs | Éditeur de boîte de dialogue de l’interface utilisateur classique en CRXDE Lite. Adobe ne prévoit pas d’améliorer l’éditeur de boîte de dialogue pour l’interface utilisateur classique fourni avec la distribution (Quickstart). | Aucun remplacement n’est disponible. |  |
...
| Screens | Adobe ne prévoit pas de continuer à gérer et à mettre à jour le lot com.adobe.cq.screens.mq.activemq et les configurations associées utilisées pour la configuration des éditeurs 2s. | Adobe recommande que les clients qui nécessitent encore la configuration de 2Publishers puissent utiliser l’approche de l’équilibreur de charge. |  |
