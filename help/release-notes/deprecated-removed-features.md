...
| Adobe Target | Avec l&#39;ajout de la possibilité pour AEM de se connecter au service Adobe Target à l&#39;aide de l&#39;[!DNL Adobe I/O] API Adobe Target Standard (Rest API) basée sur dans AEM 6.5, la méthode API Cible Classic (XML) est abandonnée. | Reconfigurez l’intégration en [utilisant la nouvelle API](https://helpx.adobe.com/fr/experience-manager/kt/sites/using/aem-sites-target-standard-technical-video-understand.html). |
