...
|---|---|---|---|
| [!DNL Sites] | Propriétés des fragments d’expérience pour **Statut des médias sociaux**. |  | 6.5.11.0 |
...
| Adobe Search &amp; Promote | L’intégration à Adobe Search &amp; Promote est obsolète. Adobe ne prévoit pas d’apporter d’autres améliorations à l’intégration Search &amp; Promote. L’intégration de Adobe Search &amp; Promote reste entièrement prise en charge tout en étant obsolète. |  |  |
...
| Développeurs | `Hobbes.js`. Adobe ne prévoit pas d’apporter d’autres améliorations au `hobbes.js` structure de test de l’interface utilisateur. | Adobe recommande aux clients d’utiliser l’automatisation Selenium. |  |
...
| Forms | La mise à niveau en un seul bond de LiveCycle ES4 SP1 vers AEM 6.5 Forms on JEE n’est pas disponible | Voir [chemins de mise à niveau disponibles](../forms/using/upgrade.md) dans la documentation de mise à niveau d’AEM Forms. |  |
...
| Développeurs | Supprimer `customJavaScriptPath` prise en charge dans le Gestionnaire de bibliothèques clientes HTML. | Aucun remplacement. |  |
