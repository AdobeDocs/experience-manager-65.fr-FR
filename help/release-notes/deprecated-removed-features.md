...
<table>
 <tbody>
  ...
  <tr>
   <td>Commerce</td>
   <td><p><a href="https://github.com/adobe/commerce-cif-api" target="_blank">CIF REST</a> a été fourni en 2018 sous la forme d’un ensemble de microservices permettant l’intégration entre AEM et les moteurs de commerce.</p> <p>Après l'acquisition de Magento par Adobe à la mi-2018, Adobe a décidé de changer d'approche pour deux raisons : </p> <p><strong>1.</strong> Magento possède son propre jeu d'API de commerce (REST et GraphQL) et il n'est pas recommandé de conserver deux jeux d'API. </p> <p><strong>2.</strong> Les tendances du marché ont indiqué que les clients se dirigeaient vers GraphQL, parce que c'est un moyen plus efficace d'interroger des données. En 2019, Adobe a publié le nouveau Commerce Integration Framework qui utilise les API GraphQL de Magento comme source de vérité.</p> <p>Adobe n'a pas l'intention d'investir davantage dans CIF REST. Il est vivement conseillé aux clients d’utiliser la solution de remplacement.</p> </td>
  ...
  <tr>
   ...
   <td><p>Adobe ne prévoit pas d’apporter d’autres améliorations à la plupart des composants de base (Foundation) stockés dans /libs/foundation/components.</p> <p>Recherchez les propriétés <strong>cq:deprecated</strong> et <strong>cq:deprecatedReason</strong> dans le dossier des composants.</p> <p>AEM 6.5 inclut les composants Foundation et les clients qui effectuent la mise à niveau depuis des versions antérieures peuvent continuer à les utiliser en l’état. En outre, les éléments de base demeurent entièrement soutenus tout en étant abandonnés. </p> </td>
  ...
  <tr>
   <td>Développeurs</td>
   <td><p>Hobbes.js</p> <p>Adobe n’envisage pas d’apporter d’autres améliorations à la structure de test de l’interface utilisateur hobbes.js.</p> </td>
  ...
  <tr>
   ...
   <td>Adobe recommande aux clients qui ont encore besoin de barres de contrôle pour leur code de l’ajouter à leur base de code de projet.</td>
  </tr>
  <tr>
   <td>Développeurs</td>
   ...
   <td>Adobe recommande aux clients qui ont encore besoin de Lawnchair pour leur code de l'ajouter à leur base de code de projet.</td>
  </tr>
  <tr>
   <td>Développeurs</td>
   ...
   <td>Adobe recommande aux clients qui comptent sur la capacité de la bibliothèque de refactoriser leur code pour ne plus l’utiliser.</td>
  </tr>
  <tr>
   <td>Développeurs</td>
   ...
   <td>Adobe recommande aux clients d’effectuer la mise à niveau vers AEM 6.5 pour passer à GCC pour leur mise en oeuvre.</td>
  </tr>
  <tr>
   <td>Développeurs</td>
...
| Ressources | La fonction de déchargement Ressources a été supprimée dans AEM 6.5. | Aucun remplacement. |
