...
source-git-commit: 38bf778511acb649a1c4cfa0f3210b50e821065b
workflow-type: tm+mt
...
* [hCaptcha](/help/forms/using/integrate-adaptive-forms-hcaptcha.md) et [services de Captcha Cloudflare Turnstile](/help/forms/using/integrate-adaptive-forms-turnstile.md) : AEM Forms prend en charge les services Captcha suivants :
...
* [Résolution XDP du fragment](/help/forms/using/assembler-service.md#resolve-references-on-crx-repository-resolve-references-on-crx-repository) : AEM Forms sur OSGi résout désormais les fichiers XDP de fragment référencés dans les fichiers XDP maîtres et stockés dans le référentiel CRX d’AEM.
...
* Lorsqu’un utilisateur ou une utilisatrice du pack de services 20 d’AEM Forms (6.5.20.0) envoie un e-mail contenant une pièce jointe à l’aide d’un bouton d’action « Envoyer un e-mail » dans un formulaire adaptatif, le nom de la pièce jointe apparaît sur la ligne suivante plutôt que sur la ligne intégrée. (FORMS-14426)
...
* Dans AEM Forms sur JEE, sur l’espace de travail AEM, lorsqu’un utilisateur ou une utilisatrice sélectionne un formulaire précédemment envoyé et lance un nouveau processus de formulaire, les formulaires avec des processus de données préremplis effacent toutes les données précédemment envoyées et les remplacent par les données préremplies, sans conserver les champs qui ont été manuellement remplis dans le formulaire précédent. (FORMS-15376)
...
* Mise à niveau dans les fichiers jar d’AEM Forms sur JEE : la bibliothèque `commons-collections:commons-collections:jar` est désormais incluse afin d’améliorer la résolution des dépendances et les fonctionnalités des différents traitements d’AEM Forms JEE, comme suit :
   ...
   * Amélioration du traitement de Rights Management pour sécuriser la gestion des documents et améliorer les fonctionnalités de gestion des droits.
