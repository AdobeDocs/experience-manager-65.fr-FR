...
* Les utilisateurs de ressources peuvent rechercher des images visuellement similaires. AEM affiche les images balisées intelligentes du référentiel DAM similaires à une image sélectionnée par l’utilisateur. Voir [Recherche visuelle](../assets/search-assets.md#visualsearch).
...
* RTE (Rich Text Editor) ne permet pas d’insérer un tableau incorporé en tant qu’élément de liste. (NPR-30879)
