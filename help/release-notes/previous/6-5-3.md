...
* Le référentiel intégré (Apache Jackrabbit Oak) a été mis à jour vers la version 1.10.6.
...
* Un conflit se produit lors de la création d’une copie linguistique des ressources et les ressources ne sont pas chargées vers Scene7 (NPR-30932).
