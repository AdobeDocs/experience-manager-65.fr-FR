...
* Le référentiel intégré (Apache Jackrabbit Oak) a été mis à jour vers la version 1.10.3.
...
* Les utilisateurs de ressources peuvent rechercher des images visuellement similaires. [!DNL Experience Manager] affiche les images avec balises intelligentes du référentiel DAM qui sont semblables à une image sélectionnée par l’utilisateur ou l’utilisatrice. Consultez [Recherche visuelle](/help/assets/search-assets.md#visualsearch).
...
* Problème de connectivité des balises intelligentes d’Adobe via Datapower. NPR-30026 : correctif pour CQ-4269457
...
* Si l’héritage LiveCopy est rompu, les pages Live Copy affichent des liens de copie linguistique au lieu de liens LiveCopy (NPR-30980).
...
* [!DNL Experience Manager]&#39;expéditeur d&#39;e-mail par défaut ne peut pas envoyer de courrier à un serveur SMTP distant via TLS v1.2. NPR-30476 : correctif pour GRANITE-26605

## Projets {#projects-6520}

* les valeurs dam:folderThumbnailPaths ne sont pas actualisées et affichent les anciennes miniatures même après la suppression des ressources dans le dossier. NPR-30424 : correctif pour CQ-4273667
...
* La mise à niveau de l’instance de 6.3.3.2 vers la version 6.5 entraîne des configurations OSGi en double. NPR-30130 : correctif pour CQ-4274016
...
Les principaux points forts des formulaires 6.5.2.0 [!DNL Experience Manager] sont les suivants :
...
* &grave;&grave;Le rendu de l’interface utilisateur de création de correspondance (CCR UI) échoue parfois avec l’erreur suivante dans la console :
...
UberJar pour Experience Manager 6.5.2.0 est disponible dans le [Référentiel Maven central](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.2/).
