...
* L’aperçu des rendus génère `Only empty tenantId is currently supported` erreur après la mise à niveau vers [!DNL Experience Manager] 6.5. NPR-29986 : correctif pour CQ-4272353
...
Les principaux points forts de [!DNL Experience Manager Forms] 6.5.1.0 sont les suivants :
...
* Restauration de l’étape de vérification pour le Forms adaptatif dans [!DNL Experience Manager] 6.5. Correctif pour CQ-4269583
...
* L’application Forms adaptative a cessé de prendre en charge Microsoft Windows 8.1. Correctif pour CQ-4265274
...
UberJar pour Experience Manager 6.5.1.0 est disponible dans le [Référentiel Maven central](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.1/).
...
* Activation de la prise en charge de Multi-Site Manager pour [!DNL Experience Manager Assets]. Pour plus d’informations, consultez [Réutilisation des ressources à l’aide de Multi-Site Manager pour Experience Manager Assets](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/reuse-assets-using-msm.html?lang=fr). NPR-29199 : correctif pour CQ-4259922
...
## Lots OSGi et modules de contenu
