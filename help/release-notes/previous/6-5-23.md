...
* **FORMS-15681**:When la lettre est affichée en aperçu avant impression, le contenu est modifié. En d’autres termes, certains espaces disparaissent et certaines lettres sont remplacées par des `x`.
