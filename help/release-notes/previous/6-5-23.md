...
* Sur AEM Forms 6.5.23.0, les conversions (PDFG) PS vers PDF et HTML vers PDF (WebKit) échouent. Pour résoudre le problème, téléchargez et installez le correctif à partir de [Correctifs &#x200B;](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/aem-forms-hotfix) (FORMS-21721)

* Sur AEM Forms 6.5.23.0, la conversion d’une image en PDF (PDFG) échoue. Pour résoudre le problème, téléchargez et installez le correctif à partir de [Correctifs &#x200B;](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/aem-forms-hotfix) (FORMS-22029)
...
* [!DNL Experience Manager] 6.5.23.0 nécessite [!DNL Experience Manager] 6.5. Consultez la [documentation de mise à niveau](/help/sites-deploying/upgrade.md) pour obtenir des instructions détaillées. <!-- UPDATE FOR EACH NEW RELEASE -->
...
>[!IMPORTANT]
>
> Adobe ne recommande pas de supprimer ou de désinstaller le package [!DNL Experience Manager] 6.5.23.0. Par conséquent, avant d’installer le module, vous devez créer une sauvegarde du `crx-repository` au cas où vous auriez besoin de le restaurer. <!-- UPDATE FOR EACH NEW RELEASE -->
...
UberJar pour [!DNL Experience Manager] 6.5.23.0 est disponible dans le [référentiel central Maven](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.23/). <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* **FORMS-16575** : toutes les modifications apportées au fichier XDP des fragments de disposition imbriqués dans une communication interactive ne sont pas répercutées dans l’éditeur IC.
* **FORMS-16603** : dans l’aperçu avant impression de l’interface utilisateur de l’agent de communications interactives, certaines valeurs calculées ne s’affichent pas correctement.
* **FORMS-15681**:When la lettre est affichée en aperçu avant impression, le contenu est modifié. Certains espaces disparaissent et certaines lettres sont remplacées par `x`.
...
* [Liste des lots OSGi inclus dans Experience Manager 6.5.23.0](/help/release-notes/assets/65230-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Liste des modules de contenu inclus dans Experience Manager 6.5.23.0](/help/release-notes/assets/65230-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
