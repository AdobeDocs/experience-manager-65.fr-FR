...
* Sur AEM Forms 6.5.23.0, les conversions (PDFG) PS vers PDF et HTML vers PDF (WebKit) échouent. Pour résoudre le problème, téléchargez et installez le correctif à partir de [Correctifs &#x200B;](https://experienceleague.adobe.com/fr/docs/experience-manager-65/content/release-notes/aem-forms-hotfix) (FORMS-21721)

* Sur AEM Forms 6.5.23.0, la conversion d’une image en PDF (PDFG) échoue. Pour résoudre le problème, téléchargez et installez le correctif à partir de [Correctifs &#x200B;](https://experienceleague.adobe.com/fr/docs/experience-manager-65/content/release-notes/aem-forms-hotfix) (FORMS-22029)
