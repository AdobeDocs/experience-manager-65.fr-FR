...
* Lorsqu’une personne enregistre un schéma de métadonnées comportant de nombreux champs, la requête multipart/form-data du créateur de formulaires dépasse la limite maxFileCount, ce qui entraîne des échecs silencieux. (CQDOC-22465)
