...
* Lorsque vous envoyez un formulaire adaptatif basé sur les composants principaux, l’envoi du formulaire échoue. Appliquez le bouton bascule de fonction - ft-cq-4324864 pour résoudre le problème. Pour appliquer un bouton bascule de fonction :
   1. Ouvrez l’URL : `http://[server]:[port]/system/console/configMgr`
   1. Recherchez et ouvrez le `com.adobe.granite.toggle.impl.dev.DynamicToggleProviderImpl` configuration
   1. Indiquez le numéro de la fonction toogle. Par exemple, ft-cq-4324864.
