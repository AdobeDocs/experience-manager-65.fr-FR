...
* Lors d’un déploiement avec MongoDB et plusieurs instances, installez Experience Manager 6.5.12.0 sur l’une des instances de création à l’aide du gestionnaire de packages.
