...
Voici quelques-unes des principales fonctionnalités et améliorations :

* **[Prise en charge de l’accessibilité des listes dans AEM Forms Designer](https://helpx.adobe.com/content/dam/help/fr/experience-manager/6-5/forms/pdf/using-designer.pdf)** : AEM Forms Designer permet désormais aux auteurs de créer des structures de liste accessibles en attribuant des rôles Liste, Élément de liste et Libellé de liste aux sous-formulaires via l’onglet Accessibilité. Cette fonctionnalité prend en charge les listes simples, numérotées, à puces et imbriquées, avec une `<L>`, un `<LI>`, un `<Lbl>` et une génération de balises `<Lbody>` appropriés pour la compatibilité des lecteurs d’écran. Cette amélioration garantit que les listes de formulaires sont conformes aux normes d’accessibilité de PDF/UA, ce qui améliore la navigation et la compréhension du contenu pour les utilisateurs et utilisatrices de technologies d’assistance.
...
* [!DNL Experience Manager] 6.5.14.0 nécessite [!DNL Experience Manager] 6.5. Consultez la [documentation de mise à niveau](/help/sites-deploying/upgrade.md) pour obtenir des instructions détaillées. <!-- UPDATE FOR EACH NEW RELEASE -->
