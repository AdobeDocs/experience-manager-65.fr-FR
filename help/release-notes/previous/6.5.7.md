---
title: '''[!DNL Adobe Experience Manager] 6.5.7 Notes de mise à jour du Service Pack"'
...
* [Configurer le client HTTP du modèle de données de formulaire pour optimiser les performances.](/help/forms/using/configure-data-sources.md#fdm-http-client-configuration)
