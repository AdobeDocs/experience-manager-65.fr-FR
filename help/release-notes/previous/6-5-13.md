...
Les fonctionnalités et améliorations clés introduites dans [!DNL Adobe Experience Manager] 6.5.13.0 sont les suivantes :
...
* Lorsque vous localisez un formulaire adaptatif et apportez même une petite modification au texte de la langue de base, la traduction complète est manquante pour toutes les autres langues. Le problème est résolu dans [!DNL Experience Manager] 6.5.13.0. (NPR-37189)
...
* Tout le monde dispose de jcr:write sur `/content/usergenerated/etc/commerce/smartlists`. (NPR-35230)
...
* La version d’Oak pour 6.5.13.0 a été mise à jour vers la version 1.22.11. (NPR-38084)
...
>[!NOTE]
>
>Adobe déconseille de supprimer ou de désinstaller le package [!DNL Experience Manager] 6.5.13.0.
...
>[!NOTE]
>
>[!DNL Experience Manager] 6.5.13.0 ne prend pas en charge l’installation de Bootstrap.
...
UberJar pour [!DNL Experience Manager] 6.5.13.0 est disponible dans [Référentiel Maven central](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.13/)&#x200B;(https://).
