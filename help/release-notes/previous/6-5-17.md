...
* Interface d’utilisation du profil d’image limitée pour les recadrages intelligents portant le même nom, la même dimension ou les deux. (ASSETS-16997)
* La largeur et la hauteur par défaut sont désormais définies sur 50 pixels pour les recadrages intelligents sur l’interface d’utilisation du profil d’image. (ASSETS-16997)
...
* Dans le Pack de services Forms d’Experience Manager 6.5.16.0, lorsqu’un utilisateur ou une utilisatrice tente de modifier les coordinateurs et coordinatrices d’ensembles de politiques, l’éditeur de document du gestionnaire reste toujours décoché. (FORMS-7775, FORMS-8599)
...
* Un utilisateur ou une utilisatrice ne peut pas modifier les ensembles de politiques, même si des autorisations spécifiques lui sont accordées. (FORMS-7665)
...
* Après la mise à niveau vers le Pack de services Experience Manager 6.5.14.0, les processus d’atelier pour déplacer un nœud CRX d’un emplacement à un autre ne fonctionnent pas. L’erreur `ALC-CRX-30000-000: com.adobe.ep.crx.client.exceptions.CRCException: ALC-CRX-030-000-[Internal Server Error]` se produit. (FORMS-7713)
...
* La copie linguistique n’est pas créée lorsque l’utilisateur ou l’utilisatrice ne configure pas de champs non obligatoires. (NPR-40036)
