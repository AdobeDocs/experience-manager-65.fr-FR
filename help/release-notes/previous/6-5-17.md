...
* **Streaming DASH avec Dynamic Media** - Nouveau protocole (DASH - Dynamic Adaptive Streaming over HTTP) lancé pour le streaming adaptatif dans les diffusions vidéo Dynamic Media (avec CMAF activé).
