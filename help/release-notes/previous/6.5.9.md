...
>[!NOTE]
>
>À partir du Service Pack 9, les clients et les clientes [!DNL Experience Manager] peuvent développer et exploiter leurs applications [!DNL Experience Manager] avec des distributions de builds [!DNL Azul Zulu] d’OpenJDK, conformes aux normes Java™ SE.
La prise en charge des JDK [!DNL Azul Zulu] est également fournie par Adobe pour les clients et les clientes [!DNL Experience Manager].
