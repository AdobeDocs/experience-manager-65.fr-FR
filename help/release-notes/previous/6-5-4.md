...
Voici quelques fonctionnalités et améliorations clés introduites dans Adobe Experience Manager 6.5.4.0 :
...
* Le référentiel intégré (Apache Jackrabbit Oak) a été mis à jour vers la version 1.10.8.
...
### Configuration de [!DNL Experience Manager Assets] avec [!DNL Brand Portal] (6.5.4.0) {#configure-assets-bp}
...
* Il n’est pas possible d’afficher le rapport Analytics sur l’instance de création (NPR-30913).
...
UberJar pour Experience Manager 6.5.4.0 est disponible dans le [Référentiel Maven central](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.4/).
