...
* Le conteneur de mises en page dans un modèle de page SPA ne peut pas enregistrer les classes CSS personnalisées définies dans la politique de modèle lors de l’exécution des pages SPA React (NPR-37697).
