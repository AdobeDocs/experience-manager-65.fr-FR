...
* Si vous mettez à niveau votre instance [!DNL Experience Manager] de 6.5.0 à 6.5.4 vers le dernier Service Pack sur Java 11, vous pouvez voir les exceptions `RRD4JReporter` dans le fichier `error.log`. Pour arrêter les exceptions, redémarrez votre instance d’[!DNL Experience Manager]. <!-- THIS BULLET POINT WAS UPDATED AS PER CQDOC-20021, JANUARY 23, 2023 -->
