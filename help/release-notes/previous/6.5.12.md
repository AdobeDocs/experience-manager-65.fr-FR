...
Pour plus d’informations sur l’installation du programme d’installation cumulatif pour Experience Manager Forms on JEE et la configuration après le déploiement, voir la section [notes de mise à jour](/help/release-notes/jee-patch-installer-65.md).
