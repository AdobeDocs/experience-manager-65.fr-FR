...
* Le référentiel intégré (Apache Jackrabbit Oak) a été mis à jour vers la version 1.22.9.
...
* Experience Manager 6.5.11.0 nécessite Experience Manager 6.5. Consultez la [documentation de mise à niveau](/help/sites-deploying/upgrade.md) pour obtenir des instructions détaillées.
...
1. Download the corresponding Forms add-on package listed at [AEM Forms releases](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=fr#forms-updates) for your operating system.
