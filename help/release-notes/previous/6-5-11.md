...
* AEM Forms on JEE prend désormais en charge Apache Geode en tant que solution de mise en cache. Si vous utilisez actuellement AEM 6.5 Forms Service Pack 10 ou version antérieure, Adobe recommande d’effectuer une mise à niveau vers le dernier Service Pack disponible. Vous pourrez ainsi tirer pleinement parti de la solution Apache Geode en tant que solution de mise en cache.
