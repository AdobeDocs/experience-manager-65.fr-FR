...
* Lorsque vous installez AEM 6.5 Service Pack 11, vous pouvez rencontrer des problèmes avec la fonctionnalité de recherche Assets (Images). Si tel est le cas, il est recommandé de mettre à niveau vers la version 6.5.12.0 et d’installer le correctif approprié.
