...
* You can now use [!DNL Dynamic Media] to configure General Settings instead of having to go through the [!DNL Dynamic Media Classic] desktop application. Voir [Configuration des paramètres généraux de Dynamic Media](/help/assets/dm-general-settings.md).
...
>[!CAUTION]
>
>Une nouvelle version du package &quot;définition d&#39;index&quot; est en cours de développement. The link below will be published as soon as it is made available.
>
>En attendant, vous pouvez également effectuer la mise à niveau vers la version 6.5.12.0 et contacter l’assistance clientèle pour obtenir le correctif.
