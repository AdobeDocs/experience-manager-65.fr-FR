...
La version UberJar mise à jour pour la version 6.5.4.0, qui comprend le package **com.fasterxml.jackson.core.async** , est disponible dans le référentiel [](https://repo.adobe.com/nexus/content/groups/public/com/adobe/aem/uber-jar/6.5.4-1.0/)Adobe Public Maven.

Si vous utilisez la version mise à jour d’UberJar, incluez la dépendance suivante dans le POM de votre projet :
