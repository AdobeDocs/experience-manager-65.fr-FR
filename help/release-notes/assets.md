...
Voici les principales fonctionnalités et les points saillants de la version [!DNL Adobe Experience Manager] 6.5 [!DNL Assets].

## Intégration à [!DNL Adobe Creative Cloud] et aux workflows créatifs {#integration-with-adobe-creative-cloud-and-creative-workflows}
...
Lisez ce qui suit pour connaître les fonctionnalités et intégrations spécifiques de [!DNL Experience Manager] 6.5 que vous pouvez exploiter pour mieux prendre en charge vos cas d&#39;utilisation de la vitesse du contenu.

### Adobe Asset Link {#aal}

[!DNL Adobe Asset Link] renforce la collaboration entre les créatifs et les marketeurs dans le processus de création de contenu. Les créatifs peuvent accéder au contenu stocké dans [!DNL Experience Manager Assets], sans quitter les applications qui leur sont familières. Les créatifs peuvent parcourir, rechercher, extraire et archiver facilement des ressources à l’aide du panneau intégré dans les applications [!DNL Adobe Photoshop], [!DNL Adobe Illustrator] et [!DNL Adobe InDesign].

[!DNL Adobe Asset Link] fait partie du  [Creative Cloud de l&#39;](https://www.adobe.com/creativecloud/business/enterprise.html) offre d&#39;entreprise. Pour plus d&#39;informations à ce sujet, y compris la configuration nécessaire de votre déploiement [!DNL Experience Manager], voir [Adobe Asset Link](https://helpx.adobe.com/fr/enterprise/using/adobe-asset-link.html).

![Recherche de ressources en Adobe Photoshop](assets/asset_search_photoshop.png)

### [!DNL Adobe Stock] intégration  {#stock}

Votre entreprise peut utiliser son plan d&#39;entreprise [!DNL Adobe Stock] dans [!DNL Experience Manager Assets] pour s&#39;assurer que les ressources sous licence sont largement disponibles pour vos projets créatifs et marketing. Vous pouvez rapidement rechercher, prévisualisation et accorder une licence aux ressources [!DNL Adobe Stock] enregistrées dans le Experience Manager, en utilisant les puissantes fonctionnalités de gestion des actifs numériques de [!DNL Experience Manager].
...
Pour plus d’informations, voir [Utilisation des ressources Adobe Stock dans les ressources Experience Manager](/help/assets/aem-assets-adobe-stock.md).
...
Gérez vos fichiers vidéo 360 directement dans [!DNL Experience Manager] à l&#39;aide des visionneuses de pointe pour fournir des expériences VR aux ordinateurs de bureau, aux périphériques mobiles et aux casques VR. Pour plus d’informations, consultez [Utilisation de la vidéo 360°](/help/assets/360-video.md)
