...
## Intégration à [!DNL Adobe Creative Cloud] et workflows créatifs {#integration-with-adobe-creative-cloud-and-creative-workflows}
...
Lisez la suite pour connaître les fonctionnalités et intégrations spécifiques de [!DNL Experience Manager] 6.5 que vous pouvez utiliser pour mieux prendre en charge vos cas d’utilisation de vitesse du contenu.
...
[!DNL Dynamic Media] fournit une création et une diffusion rich-media améliorées dans  [!DNL Experience Manager Assets] afin de générer des expériences de pointe immersives et personnalisées. En chargeant une seule ressource Principale de haute qualité et en utilisant les visionneuses et le rendu cloud avancé d’Adobe, vous pouvez diffuser n’importe quelle combinaison de rendus à la volée pour prendre en charge la stratégie multimédia de votre entreprise.
...
Gérez vos fichiers vidéo 360 directement dans [!DNL Experience Manager] à l’aide des visionneuses de pointe pour offrir des expériences VR aux ordinateurs de bureau, aux appareils mobiles et aux casques VR. Pour plus d’informations, voir [Utilisation de la vidéo 360](/help/assets/360-video.md).
