...
L’API JavaScript ContextHub est disponible pour vos scripts lorsque la variable [Le composant ContextHub a été ajouté à la page.](/help/sites-developing/ch-adding.md#adding-contexthub-to-a-page-component).
