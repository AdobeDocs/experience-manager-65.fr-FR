...
1. Créez un fichier (par exemple, `Page.js`) pour le composant de page modifiable. Ici, le composant de page peut être réutilisé, fourni dans `@adobe/cq-react-editable-components`.
