---
title: Variables dans les processus AEM
seo-title: Variables dans les processus AEM
...
# Variables dans les processus AEM{#variables-in-aem-workflows}
...
* [Utilisez la variable](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) dans OU Split et passez aux étapes du processus AEM pour définir une expression pour prendre des décisions de routage. Vous pouvez également utiliser des variables dans toutes les étapes du processus AEM Forms.
...
1. Faites correspondre davantage de variables pour créer une expression significative. Tap ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) to save the changes.
...
Pour plus d’informations sur les API pour les types de données de variables complexes supplémentaires disponibles dans les processus AEM Forms, voir [Variables dans les processus](/help/forms/using/variable-in-aem-workflows.md)AEM Forms.
...
Dans cette API, la variable **variableName** est définie sur **value **using metaData.put(variableName, valeur);
