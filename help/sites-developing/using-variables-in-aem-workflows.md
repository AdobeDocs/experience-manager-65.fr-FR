...
description: Créez une variable, définissez une valeur pour la variable, puis utilisez-la dans les étapes de workflow Division OU et Atteindre AEM.
seo-description: Créez une variable, définissez une valeur pour la variable, puis utilisez-la dans les étapes de workflow Division OU et Atteindre AEM.
...
* [Utilisez les étapes de workflow ](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) Division OU et Atteindre AEM variable pour définir une expression permettant de prendre des décisions de routage. Vous pouvez également utiliser des variables dans toutes les étapes du workflow AEM Forms.
...
1. Faites glisser l’étape **Définir une variable** vers l’éditeur de processus, appuyez sur l’étape et sélectionnez ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/configure_icon.png) (Configurer).
...
1. Mappez davantage de variables pour créer une expression significative. Appuyez sur ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) (Enregistrer) pour enregistrer les modifications.
...
Pour obtenir d’autres exemples, voir [Création d’un modèle de workflow](/help/forms/using/aem-forms-workflow.md#create-a-workflow-model).
...
Pour plus d’informations sur les API pour les types de données de variables complexes supplémentaires disponibles dans les workflows AEM Forms, voir [Variables dans les workflows AEM Forms](/help/forms/using/variable-in-aem-workflows.md).
...
1. Appuyez sur l’icône ![](https://helpx.adobe.com/content/dam/help/images/en/edit.png) (Modifier) en regard du nom de variable que vous souhaitez modifier.
1. Modifiez les informations de la variable et appuyez sur ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) pour enregistrer les modifications. Vous ne pouvez pas modifier les champs **[!UICONTROL Nom]** et **[!UICONTROL Type]** d’une variable.
