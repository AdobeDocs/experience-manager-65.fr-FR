...
Les définitions des modèles de workflow, lanceurs, scripts et notifications sont conservées dans le référentiel selon leur type, c’est-à-dire prêtes à l’emploi, personnalisées, etc.
