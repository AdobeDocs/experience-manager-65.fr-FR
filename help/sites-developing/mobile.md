...
AEM utilise une version tronquée de la base de données [WURFL](https://wurfl.sourceforge.net/)™ pour interroger les fonctionnalités de l’appareil, telles que la résolution d’écran ou la prise en charge JavaScript, en fonction de l’agent utilisateur de l’appareil.
...
1. AEM redirige la demande vers `https://localhost:4503/content/geometrixx_mobile/en/products.touch.html.`
