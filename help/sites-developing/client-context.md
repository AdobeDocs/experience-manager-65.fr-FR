...
1. Cliquez avec le bouton droit de la souris sur le noeud /apps/myapp/contextstores/geoloc, puis cliquez sur Créer > Créer un fichier. Indiquez le nom du fichier init.js.jsp, puis cliquez sur OK.
...
1. Ouvrez la page d’accueil des Geometrixx Outdoors sur l’instance de création ([https://localhost:4502/content/geometrixx-outdoors/en.html](https://localhost:4502/content/geometrixx-outdoors/en.html)).
