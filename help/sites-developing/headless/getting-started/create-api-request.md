...
1. Connectez-vous à AEM et accédez au [Interface GraphiQL](/help/assets/content-fragments/graphiql-ide.md):
...
* **[IDE GraphiQL](/help/assets/content-fragments/graphiql-ide.md)** pour plus d’informations sur l’utilisation de l’IDE GraphiQL
* **[Requêtes persistantes](/help/assets/content-fragments/persisted-queries.md)** pour plus d’informations sur les requêtes persistantes
