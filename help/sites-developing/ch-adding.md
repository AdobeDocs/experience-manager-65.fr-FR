...
Notez que vous devez également configurer si la barre d’outils ContextHub s’affiche en mode Aperçu. Voir [Affichage et masquage de l’IU ContextHub](ch-configuring.md#showing-and-hiding-the-contexthub-ui).
