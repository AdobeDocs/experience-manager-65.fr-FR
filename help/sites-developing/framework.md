...
Le tableau suivant présente quelques exemples d’ID de balise, leurs éléments et la manière dont l’ID de balise se résout en chemin absolu dans le référentiel :Le tableau suivant présente quelques exemples d’ID de balise, leurs éléments et la manière dont l’ID de balise se résout en chemin absolu dans le référentiel :
