...
>[!NOTE]
>
>Cet article est basé sur le cadre Réagir. Pour le document correspondant au cadre angulaire, voir [Prise en main de la SPA dans AEM - Angular](/help/sites-developing/spa-getting-started-angular.md).
