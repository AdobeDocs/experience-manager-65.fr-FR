...
Le chemin d’accès au composant est unique et référence le composant par défaut en tant que type de super ressource. Il y a moins de risque, car la portée est limitée par rapport à la portée globale d’une incrustation de composant.
