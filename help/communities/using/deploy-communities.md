...
* Installez la dernière [mise à jour AEM 6.5](#aem64updates).
...
* Suivez la même procédure pour les deux agents :
   ...
   * **Agent de réplication inverse (publication inversée)**
      ...
      1. Si l’utilisateur n’est pas `admin`, modifiez les valeurs **Utilisateur** et **Mot de passe** pour spécifier un membre du groupe d’utilisateurs `administrators`.
...
* Sur **author**, connectez-vous avec les privilèges d’administrateur.
