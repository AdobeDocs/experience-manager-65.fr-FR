...
* Activer [Adobe Analytics](/help/communities/analytics.md) pour AEM Communities.
* Configurer [email](/help/communities/email.md)
* Identifier [Administrateurs de la communauté](/help/communities/users.md#creating-community-members).
* [Activation du gestionnaire OAuth](/help/communities/social-login.md#adobe-granite-oauth-authentication-handler) pour la connexion sociale.
...
>
>Pour ce faire, activez la variable ` [AEM Communities Publish Tunnel Service](/help/communities/deploy-communities.md#tunnel-service-on-author)` pour l’environnement de création.
