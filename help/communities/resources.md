...
* **[!UICONTROL Mettre en place l’ordre du cursus de formation]**
   ...
   (*Facultatif*) Si cette option est activée, l’ordre dans lequel les ressources d’activation sont ajoutées correspond à l’ordre dans lequel les apprenants doivent suivre le parcours d’apprentissage. La valeur par défaut est Désactivé.
...
* Sélectionnez l’icône du monde à `Publish`utiliser.
