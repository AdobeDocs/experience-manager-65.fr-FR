...
![configuration des paramètres d’icône](assets/configure.png) ![commentaires](assets/commentssettings.png)
...
* **Autoriser les réponses**
   ...
   Si elle est cochée, permet aux membres de répondre aux commentaires existants. La valeur par défaut est désélectionnée.
...
* **Autoriser les transferts de fichiers**
   ...
   Si cette option est cochée, l’option de téléchargement d’un fichier s’affiche avec la zone de texte. La valeur par défaut est désélectionnée.
...
* **Éditeur de texte enrichi**
   ...
   Si cette option est cochée, les commentaires sont saisis avec une annotation. La valeur par défaut est désélectionnée.

* **Autoriser le vote**

   Si cette option est cochée, l’option permettant de voter vers le haut ou vers le bas s’affiche avec la zone de texte. La valeur par défaut est désélectionnée.
...
* **Afficher les badges**
   ...
   Si cette option est cochée, autorisez l’affichage des badges gagnés et attribués. La valeur par défaut est désélectionnée.
...
* **Supprimer les commentaires**
   ...
   Si cette option est cochée, le membre qui a publié le commentaire peut le supprimer. La valeur par défaut est désélectionnée.
...
* **Marquer les commentaires**
   ...
   Si cette option est cochée, permettez aux membres de signaler les commentaires comme inappropriés. La valeur par défaut est désélectionnée.
