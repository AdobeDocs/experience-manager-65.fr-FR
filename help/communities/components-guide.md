...
>[!NOTE]
>
>Sachez que si la valeur par défaut de la SRP est définie sur [JSRP](jsrp.md), le contenu généré par l’utilisateur saisi sur l’instance de publication ne sera visible que lors de la publication et sera *not* être visible à partir de la fonction [modération](moderate-ugc.md) sur l’instance d’auteur.
