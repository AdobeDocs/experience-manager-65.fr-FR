...
Lorsque les [bibliothèques client requises](/help/communities/ideation.md#essentials-for-client-side) sont incluses, c&#39;est ainsi que le composant `Ideation` apparaîtra :
