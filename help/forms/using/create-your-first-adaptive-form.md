...
# Didacticiel : Créez votre premier formulaire adaptatif {#tutorial-create-your-first-adaptive-form}
...
* Obtenez le pilote de base de données JDBC (fichier JAR) auprès du fournisseur de base de données. Les exemples du didacticiel sont basés sur la base de données [!DNL MySQL] et utilisent [!DNL Oracle's] [le pilote de base de données JDBC MySQL](https://dev.mysql.com/downloads/connector/j/5.1.html).
