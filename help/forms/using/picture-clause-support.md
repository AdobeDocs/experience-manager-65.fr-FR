...
>[!NOTE]
>
> Selon la conception, le champ Date dans HTML5 Forms ne prend pas en charge la variable `MM-YYYY` au format d’édition. Toutefois, ce format est pris en charge dans le format d’affichage.
