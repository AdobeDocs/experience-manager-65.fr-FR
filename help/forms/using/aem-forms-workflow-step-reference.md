...
* **Paramètres de partage :** La boîte de réception AEM propose des options pour partager une seule tâche ou toutes les tâches de la boîte de réception avec d’autres utilisateurs :
...
(Valeur par défaut) Utilisez le paramètre régional configuré sur le serveur AEM Forms. Le paramètre régional est configuré à l’aide d’Administration Console. (Voir l’[aide de Designer](http://www.adobe.com/go/learn_aemforms_designer_65).)
