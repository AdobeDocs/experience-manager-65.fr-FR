...
>[!NOTE]
>
>Pour modifier la langue de l’écran de connexion de l’espace de travail AEM Forms, voir [Création d’un écran de connexion](../../forms/using/creating-new-login-screen.md).
