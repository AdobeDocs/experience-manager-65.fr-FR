...
description: Découvrez comment configurer les points de fin Watched Folder. Si un document est placé dans le dossier de contrôle, une opération de service configurée est appelée et manipule le fichier.
contentOwner: admin
