...
**Lorsque non conforme :** Indique si le fichier PDF doit être créé si le fichier PostScript ne respecte pas les exigences PDF/X. Cette option est disponible si une valeur autre qu’Aucune est affectée à l’option Norme de conformité de la page Rapport et conformité aux normes.
...
**Redimensionner la fenêtre en page initiale :** Ajuste la fenêtre de document pour l’ajuster en douceur autour de la page d’ouverture, en fonction des options sélectionnées sous Options de Document.
