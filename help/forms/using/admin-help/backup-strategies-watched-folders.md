...
**T3 :** l’opération de service déplace le fichier2 dans le dossier de traitement pour la manipulation. Elle place les résultats du fichier1 dans le dossier output et déplace le fichier1 dans le dossier preserve.
