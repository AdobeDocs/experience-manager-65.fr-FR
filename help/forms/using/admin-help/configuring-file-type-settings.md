...
**[!UICONTROL Convertir des styles spécifiés en signets]** : permet de convertir les styles définis dans le champ  **[!UICONTROL Styles avec]** niveaux en signets dans le document PDF.
