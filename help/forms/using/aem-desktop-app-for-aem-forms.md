...
1. Dans la fenêtre de la console Web, recherchez et ouvrez le **[!UICONTROL Configuration du module complémentaire FormsManager]** .
...
1. Redémarrer le serveur AEM Forms. Après le redémarrage, le serveur AEM Forms est activé pour accepter et partager du contenu avec l’appli de bureau AEM.
