...
### Intégrer Target à AEM Forms {#integrate-target-in-aem-forms}
...
1. Dans le champ **URL Target**, spécifiez toutes les URL où les tests A/B seront exécutés. Par exemple, https://&lt;*nom de lʼhôte*>:&lt;*port*>/ pour le serveur AEM Forms sur OSGi ou https://&lt;*nom de lʼhôte*>:&lt;*port*>/lc/ pour le serveur AEM Forms sur JEE.
...
## Créer un test A/B {#create-a-b-test}
...
1. Dans les champs **Distribution d’expérience** pour les expériences A et B, spécifiez la répartition, sous forme de pourcentage, pour déterminer la répartition des expériences dans l’audience totale. Par exemple, si vous spécifiez respectivement 40 et 60 pour les expériences A et B, l’expérience A sera transmise à 40 % de l’audience et les 60 % restants verront l’expérience B.
