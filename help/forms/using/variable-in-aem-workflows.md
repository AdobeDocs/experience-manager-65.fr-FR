...
seo-title: Variables dans les Workflows AEM Forms
...
* [Créez une ](../../forms/using/variable-in-aem-workflows.md#create-a-variable) variable d’un type de données en fonction du type d’informations que vous souhaitez y stocker.
* [Définissez une valeur pour la ](../../forms/using/variable-in-aem-workflows.md#set-a-variable) variable à l’aide de l’étape de flux de travail Définir la variable.
* [Utilisez la ](../../forms/using/variable-in-aem-workflows.md#use-a-variable) variable dans toutes les étapes du processus AEM Forms pour récupérer la valeur stockée et dans les étapes OU Split et Goto pour définir une expression de routage.
...
1. Faites correspondre davantage de variables pour créer une expression significative. Appuyez sur ![done_icon](assets/done_icon.png) pour enregistrer les modifications.
...
Pour plus d’exemples, voir [Création d’un modèle de processus](../../forms/using/aem-forms-workflow.md#create-a-workflow-model).
...
Toutes les étapes du processus AEM Forms prennent en charge les variables. Pour plus d’informations, voir [Processus centré sur Forms sur OSGi](../../forms/using/aem-forms-workflow-step-reference.md).
...
Vous avez besoin du [module complémentaire AEM Forms](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) pour les types de données de variable de Document et de modèle de données de formulaire.
...
1. Appuyez sur l&#39;icône ![modifier](assets/edit.png) (Modifier) en regard du nom de variable que vous souhaitez modifier.
1. Modifiez les informations de la variable et appuyez sur ![done_icon](assets/done_icon.png) pour enregistrer les modifications. Vous ne pouvez pas modifier les champs **[!UICONTROL Nom]** et **[!UICONTROL Type]** pour une variable.
...
Pour plus d&#39;exemples sur l&#39;utilisation des variables dans les étapes du processus AEM Forms, consultez [Variables dans les workflows AEM](https://helpx.adobe.com/experience-manager/kt/forms/using/authoring_variables_in_aem_forms-workflow1.html).
