...
1. Cliquez sur **Enregistrer** pour enregistrer les détails.
   ...
   >[!NOTE]
   >
   > Pour en savoir plus sur les notifications de tâche, [cliquez ici](https://experienceleague.adobe.com/docs/experience-manager-65/content/forms/administrator-help/configuring-email-endpoints.html?lang=fr#create-an-email-endpoint-for-the-complete-task-service).
...
1. Cliquez sur **Enregistrer** pour enregistrer les détails.
   ...
   >[!NOTE]
   >
   > Pour plus d’informations sur la configuration des points d’entrée d’e-mail, cliquez sur [Configuration d’un point d’entrée d’e-mail](https://experienceleague.adobe.com/docs/experience-manager-65/content/forms/administrator-help/configuring-email-endpoints.html?lang=fr).
