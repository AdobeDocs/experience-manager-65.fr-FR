...
![Présentation d’Analytics](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>Dans le cas des deux [Analytics hérité](/help/forms/using/configure-analytics-forms-documents.md) et les fonctionnalités Launch Analytics sont activées simultanément, **Launch Analytics** est prioritaire.
...
1. Appuyez sur le champ et sélectionnez ![Éditeur de règles](/help/forms/using/assets/edit-rules-icon.svg) pour ouvrir la page de l’éditeur de règles.
