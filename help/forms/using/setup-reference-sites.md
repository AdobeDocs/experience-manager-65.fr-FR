---
title: Configuration des sites de référence en libre-service We.Finance et Employee
seo-title: Configuration des sites de référence en libre-service We.Finance et Employee
...
# Configuration des sites de référence en libre-service We.Finance et Employee{#set-up-and-configure-we-finance-and-employee-self-service-reference-sites}
...
Le site de référence We.Finance tire des cas d&#39;utilisation réels pour engager le dialogue avec les clients existants et potentiels, dès le premier contact jusqu&#39;à la gestion personnalisée et rentable des correspondances et des transactions.
...
1. Appuyez sur **Enregistrer**. Patientez un moment le temps que tous les services redémarrent.
...
Installez les packages des sites de référence à l’aide du partage de package.

* [Package du site de référence FSI AEM Forms](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq650/fd/AEM-FORMS-6.5-FSI-REF-SITE)
* [Package du site de référence du gouvernement AEM Forms](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq650/fd/AEM-FORMS-6.5-GOV-REF-SITE)
...
* https://[serveur]:[port]/wegov
* https://[serveur]:[port]/wefinance
...
1. On AEM author instance, go to **Tools** > **Cloud Services** > **Data Sources** > **global**. Appuyez sur l’icône Intégration **de la dynamique** de site de référence et appuyez sur Propriétés.
...
1. Go to **Tools** > **Cloud Services** > **Adobe Sign** > **global**. Sélectionnez **AEM Forms Reference Site Sign** et appuyez sur Propriétés.
...
Les cas d’utilisation de demandes de carte de crédit et de demandes de prêt immobilier montrent comment effectuer des tests A/B et présenter un rapport à des fins de démonstration. Pour consulter les procédures pas à pas, consultez la présentation [du site de référence](../../forms/using/finance-reference-site-walkthrough.md)Web.Finance.
