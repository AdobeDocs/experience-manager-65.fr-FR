...
**[!UICONTROL Accéder à]** Permet d’accéder à d’autres ressources Forms adaptatives, à d’autres ressources telles que des images ou des fragments de document ou à une URL externe.
