...
1. Vous pouvez utiliser l’étape [Envoyer un courrier électronique](../../forms/using/aem-forms-workflow-step-reference.md#send-email-step) pour envoyer des courriers électroniques.
