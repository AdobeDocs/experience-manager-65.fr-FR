...
Lorsqu’un formulaire XDP est rendu au format HTML à l’aide du package de formulaires mobiles déployé sur CRX, il ajoute également `FormBridge`du code JavaScript au formulaire, ce qui expose différentes méthodes d’enregistrement et d’envoi des données de formulaire.
