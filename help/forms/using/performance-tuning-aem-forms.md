...
Cet article décrit les stratégies et bonnes pratiques que vous pouvez implémenter pour réduire les goulets d’étranglement et optimiser les performances de votre déploiement AEM Forms.
...
* **Aucun**: applique de ne pas mettre en cache d’artefact. En pratique, cela ralentit les performances et nécessite une disponibilité élevée de la mémoire en raison de l’absence de cache.
...
Par exemple, effectuez les étapes suivantes pour activer la compression sur Apache Web Server 2.0 32 bits avec JBoss® :
...
* AEM Répertoire d&#39;installation. S’il n’est pas possible d’exclure le répertoire complet, excluez les éléments suivants :
...
* **(AEM Forms on JEE uniquement)** Journaux du serveur AEM Forms et répertoire temporaire. L’emplacement par défaut est :
