...
1. Dans le coin supérieur gauche, cliquez sur **Adobe Experience Manager** > **Outils** ![](/help/forms/using/assets/tools.png) > **Services sur le cloud** > **Services sur le cloud hérités**.
