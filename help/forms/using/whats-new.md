...
Pour plus d&#39;informations sur la configuration et l&#39;utilisation des rapports de transactions, voir [Présentation des rapports de transactions](../../forms/using/transaction-reports-overview.md).
...
Les auteurs de communications interactives peuvent désormais définir des [modèles d’affichage de données](create-interactive-communication.md#datadisplaypatterns) pour les champs, les variables et les éléments de modèle de données de formulaire. Par exemple, les formats de date, de devise ou de téléphone.

**Utiliser de nouveaux types de graphiques**

Vous pouvez maintenant ajouter des graphiques et des graphiques quadrant [avec plusieurs séries](../../forms/using/chart-component-interactive-communications.md) à Interactive Communications.
...
Vous pouvez maintenant ajouter des composants Bouton et Séparateur au canal Web. Pour plus d’informations, voir [Composant Bouton d’Ajoute sur le canal Web](../../forms/using/create-interactive-communication.md#add-button-component-to-the-web-channel) et [Composant Séparateur dans le canal Web](../../forms/using/create-interactive-communication.md#separatorcomponent).

**Mode de mise en page pour redimensionner les composants**

Vous pouvez maintenant passer en [mode Mise en page](../../forms/using/resize-using-layout-mode.md) pour redimensionner les composants du canal Web à l&#39;aide d&#39;une interface WYSIWYG.
...
Les formulaires adaptatifs ont ajouté la prise en charge de la propriété cq:allowedPaths. La propriété [limite la disponibilité des modèles Forms adaptatif aux chemins spécifiques](creating-adaptive-form.md#adaptive-form-templates).
...
### Utiliser des variables dans AEM Workflows {#use-variables-in-aem-workflows}
...
* [Validez les ](../../forms/using/work-with-form-data-model.md#automated-validation-of-input-data) données d’entrée en fonction d’une liste de contraintes. Elle permet de s’assurer que seules les données valides sont envoyées à la source de données.
* [Remplacez les points de ](../../forms/using/configure-data-sources.md#configure-soap-web-services) terminaison par défaut définis dans un fichier WSDL (Web Services Description Language).

* [Remplacer le schéma ](../../forms/using/configure-data-sources.md#configure-restful-web-services) [par défaut, l’hôte et le ](../../forms/using/configure-data-sources.md#configure-restful-web-services) chemin de base définis dans le fichier de définition Swagger.
...
AEM Forms peut être installé à l’aide de n’importe quelle combinaison de systèmes d’exploitation, serveurs d’applications, bases de données, pilotes de base de données, JDK, serveurs LDAP et serveurs de messagerie électronique pris en charge. Voici les principales modifications apportées aux [plateformes prises en charge](../../forms/using/aem-forms-jee-supported-platforms.md) :
...
* AEM 6.5 Forms utilise désormais jQuery à 3.2.1 et jQuery UI 1.12.1. Voir [documentation de mise à niveau](/help/forms/home.md) pour connaître l&#39;impact de la modification.
