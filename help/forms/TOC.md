...
+ Notes de mise à jour {#release-notes-new-features}
   ...
   + [Fonctions obsolètes](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/deprecated-removed-features.html)
+ Prise en main {#getting-started}
   ...
   + [Présentation du service de conversion automatisée des formulaires](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/introduction.html)
   + Tutorial: Create your First Adaptive Form {#create-first-adaptive-form}
      ...
      + [Didacticiel : Publication du formulaire adaptatif](/help/forms/using/publish-your-adaptive-form.md)
   ...
   + AEM Forms Reference Collaterals {#aem-forms-reference-collaterals}
      + [Configuration des sites de référence en libre-service We.Finance et Employee](using/setup-reference-sites.md)
...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plates-formes prises en charge pour AEM Forms sur OSGi](https://docs.adobe.com/content/help/en/experience-manager-65/deploying/introduction/technical-requirements.html)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Installation et déploiement d’AEM Forms sur JEE pour WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_65)
      + [Installation d’AEM Forms Workbench](using/install-workbench.md)
      + [Installation et configuration de Designer](using/installing-configuring-designer.md)
      + [Préparation à l’installation de la grappe de serveurs AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_65)
      + [Configuration d’AEM Forms sur JEE sur une grappe JBoss](http://www.adobe.com/go/learn_aemforms_clusterJBoss_65)
      + [Configuration d’AEM Forms sur JEE sur une grappe WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
...
+ Mise à niveau d’AEM Forms {#upgrade-aem-forms}
   ...
   + Mise à niveau d’AEM Forms sur JEE {#aem-forms-jee-upgrade}
      ...
      + [Aide-mémoire et planification de la mise à niveau](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
      + [Mise à niveau vers AEM Forms 6.5 sur JEE](using/upgrade-forms-jee.md)
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.5 sur JEE pour JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.5 sur JEE pour JBoss clé en main](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.5 sur JEE pour WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
...
+ Formulaires adaptatifs - Création avancée {#adaptive-forms-advanced-authoring}
   ...
   + [Incorporation d’un formulaire adaptatif ou d’une communication interactive dans une application d’une seule page des sites AEM](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ Workflows {#workflows}
   ...
   + [Connexion aux processus AEM Forms](/help/forms/using/forms-workflow-logs.md)
   + [Variables dans les processus AEM](using/variable-in-aem-workflows.md)
...
+ Concepteur Forms {#use-forms-designer}
   ...
   + [Didacticiels de mise en route de Designer](http://www.adobe.com/go/learn_aemforms_designer_quick_start_65)
   + [Designer – Exemples](http://www.adobe.com/go/learn_aemforms_designer_samples_65)
...
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + [Référence API Java pour AEM Forms](https://helpx.adobe.com/experience-manager/6-5/forms/javadocs/index.html)
   ...
   + [Aide de Workbench](http://www.adobe.com/go/learn_aemforms_workbench_65)
