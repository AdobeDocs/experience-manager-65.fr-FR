...
+ Prise en main {#getting-started}
   ...
   + Tutoriel : Créer votre premier formulaire adaptatif {#create-first-adaptive-form}
      ...
      + [Tutoriel : Test de votre formulaire adaptatif](/help/forms/using/testing-your-adaptive-form.md)
...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plateformes prises en charge pour AEM forms on OSGi](https://docs.adobe.com/content/help/en/experience-manager-65/deploying/introduction/technical-requirements.html)
   ...
   + Installation d’AEM Forms on JEE {#jee-installation}
      ...
      + [Installation et déploiement d’Adobe Experience Manager forms on JEE pour WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_65)
...
+ Mettre à niveau AEM Forms {#upgrade-aem-forms}
   ...
   + Mise à niveau d’AEM Forms on JEE {#aem-forms-jee-upgrade}
      ...
      + [Aide-mémoire et planification de la mise à niveau d’Adobe Experience Manager Forms on JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65_fr)
      + [Mise à niveau vers AEM 6.5 forms on JEE](using/upgrade-forms-jee.md)
...
+ Formulaires adaptatifs - Création avancée {#adaptive-forms-advanced-authoring}
   ...
   + [Incorporation d’un formulaire adaptatif ou d’une communication interactive dans une application d’une seule page AEM Sites](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
   + [Forms adaptatif Messages d’erreur de validation standard](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
+ Communications interactives {#interactive-communications}
   ...
   + [Génération de plusieurs communications interactives](using/generate-multiple-interactive-communication-using-batch-api.md)
