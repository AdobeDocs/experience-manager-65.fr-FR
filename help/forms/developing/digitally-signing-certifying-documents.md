...
Effectuez une itération sur chaque signature. Autrement dit, pour chaque signature, vérifiez la signature numérique, l’identité du signataire ainsi que l’état de chaque signature. (Voir [Vérifier des signatures numériques](#verify-digital-signatures-using-the-java-api).)
