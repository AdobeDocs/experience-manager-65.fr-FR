...
>[!NOTE]
>
>Il est recommandé de ne pas dépasser 30 Mo lorsque vous renseignez un `BLOB` objet en appelant sa `setBinaryData` méthode. Sinon, il est possible qu’une `OutOfMemory` exception se produise.
