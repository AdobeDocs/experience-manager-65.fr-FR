...
1. Spécifier le contenu de la ressource
   ...
   * Appeler la méthode `ResourceContent` de l’ `setSize` objet et transmettre la taille en octets de l’ `Document` objet
   ...
   Ajoutez le contenu à la ressource en appelant la `Resource` méthode de l’ `setContent` objet et en transmettant l’ `ResourceContent` objet. For more information, see [AEM Forms API Reference](https://www.adobe.com/go/learn_aemforms_javadocs_63_en).
