...
[Assemblage de plusieurs fragmentsXDP](assembling-multiple-xdp-fragments.md#assembling-multiple-xdp-fragments)Démarrage[rapide (mode SOAP) : Assemblage de plusieurs fragments XDP à l’aide de l’API](/help/forms/developing/assembler-service-java-api-quick.md#quick-start-soap-mode-assembling-multiple-xdp-fragments-using-the-java-api)Java[Inclusion de fichiers](/help/forms/developing/invoking-aem-forms-using-java.md#including-aem-forms-java-library-files)[de bibliothèque Java AEM Forms Définition des propriétés de connexion](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)
...
[Assemblage de plusieurs fragments](assembling-multiple-xdp-fragments.md#assembling-multiple-xdp-fragments)XDP[appelant AEM Forms à l’aide de MTOM](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-mtom)