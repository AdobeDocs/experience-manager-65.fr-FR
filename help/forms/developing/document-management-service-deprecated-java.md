...
L’exemple de code Java suivant crée un nouvel espace nommé *Tester Directory* situé dans le répertoire d’accueil de la société. La valeur d’identification du nouvel espace est écrite dans la console.
