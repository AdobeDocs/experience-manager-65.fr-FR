...
>[!NOTE]
>
>La `sling:alias` propriété peut être définie à l’aide de la propriété [Alias lors de la modification des propriétés](/help/sites-authoring/editing-page-properties.md#advanced)de la page.
