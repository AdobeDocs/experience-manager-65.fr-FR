...
Notez *que tout est contenu*, c’est-à-dire que les styles d’application, la copie (texte), les médias, les pages, la navigation et, le ciblage du contenu peuvent tous être modifiés et mis à jour OTA, sans aller dans une boutique d’applications.
...
Ici, les administrateurs ** AEM peuvent rapidement et facilement mettre à jour leurs applications pour offrir des expériences attrayantes et du contenu à jour afin de stimuler l’engagement de la marque et d’atteindre les objectifs commerciaux, sans avoir à soumettre à nouveau un développeur ou une boutique d’applications.
