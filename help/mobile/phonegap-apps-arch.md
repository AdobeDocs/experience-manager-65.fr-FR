...
description: Cette page décrit les composants de page que vous créez pour votre application. Ils sont basés sur le composant /libs/mobileapps/components/angular/ng-page (CRXDE Lite sur un serveur local).
contentOwner: User
