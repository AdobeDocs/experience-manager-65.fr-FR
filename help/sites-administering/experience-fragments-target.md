...
>* AEM doit être [intégré à Adobe Target à l’aide des E/S](/help/sites-administering/integration-ims-adobe-io.md)Adobe.
>
>
...
Les fragments d’expérience AEM peuvent être exportés vers l’espace de travail par défaut dans Adobe Target ou vers des espaces de travail définis par l’utilisateur pour Adobe Target. Cela se fait via les E/S Adobe, pour lesquelles AEM doit être [intégré à Adobe Target à l’aide des E/S](/help/sites-administering/integration-ims-adobe-io.md)Adobe.

>[!NOTE]
>
>Les espaces de travail Adobe Target n’existent pas dans Adobe Target lui-même. Ils sont définis et gérés dans Adobe IMS (Identity Management System), puis sélectionnés pour une utilisation dans toutes les solutions à l’aide des intégrations d’E/S Adobe.

>[!NOTE]
>
>Les espaces de travail Adobe Target permettent aux membres d’une organisation (groupe) de créer et de gérer des offres et des activités pour cette organisation uniquement ; sans donner accès à d&#39;autres utilisateurs. Par exemple, des organisations spécifiques à un pays dans le cadre d’une préoccupation mondiale.
...
1. Vous devez [intégrer AEM à Adobe Target à l’aide des E/S](/help/sites-administering/integration-ims-adobe-io.md)Adobe.
...
1. 
   ...
   * si nécessaire - domaine externaliseur
   >[!CAUTION]
   >
   >Le domaine externaliseur est facultatif. Un externaliseur AEM est configuré lorsque vous souhaitez que le contenu exporté pointe vers un domaine de *publication* spécifique. Pour plus d’informations, voir [Configuration de l’externaliseur](/help/sites-administering/target-requirements.md#configuring-the-aem-link-externalizer)de lien AEM.
