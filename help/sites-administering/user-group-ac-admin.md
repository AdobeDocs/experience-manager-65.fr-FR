...
* **Nom principal**
   ...
   Nom en texte intégral du compte.
...
* **Nom principal**
   ...
   Nom en texte intégral du compte de groupe.
...
* **Stratégies de contrôle d&#39;accès local**
...
* **Stratégies de contrôle d&#39;accès efficaces**
   ...
   Il s’agit des stratégies de contrôle d’accès qui sont maintenant en vigueur pour toutes les demandes d’accès. Elles affichent les stratégies agrégées dérivées des stratégies locales et des stratégies héritées du parent.
...
* **Principal**
   ...
   Principal enregistré dans le référentiel.
