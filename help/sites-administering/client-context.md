...
>[!NOTE]
>
>ClientContext a été remplacé par ContextHub. Pour plus d’informations, voir [configuration]ch-configuring.md) et [développeur](/help/sites-developing/contexthub.md) documentation.
