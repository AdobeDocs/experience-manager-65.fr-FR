...
1. Modifiez les correspondances, au besoin. The default mapping follows the pattern **aemUserAttribute=sfLeadAttribute**. Cliquez sur **Enregistrer** pour enregistrer les modifications.
