...
Distribution logicielle est utilisée pour distribuer des fonctionnalités de produit, des exemples et des correctifs logiciels. Pour plus d’informations, voir [Documentation sur la distribution logicielle](https://experienceleague.adobe.com/docs/experience-cloud/software-distribution/home.html#software-distribution).
...
1. Sélectionner **Contournement de la liste autorisée**.
1. Ajouter `com.day.cq.dam.cq-dam-jcr-connectors` dans les lots de liste autorisée par défaut
...
1. Saisissez l’ID utilisateur créé ci-dessus dans la zone de texte avant **Parcourir** bouton .
