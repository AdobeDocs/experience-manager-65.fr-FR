...
**installed** Valeur booléenne qui indique si le package est installé :

* `true`: Installé.
* `false`: Non installé.

**installedBy** ID de l’utilisateur qui a installé le package pour la dernière fois.

**installedDate** Date de la dernière installation du package.

**taille** Valeur longue qui conserve la taille du package en octets.
