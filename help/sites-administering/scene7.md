...
* Vérifiez que la ressource que vous tentez de télécharger se trouve dans le dossier de cible **** CQ (vous indiquez ce dossier dans la configuration de cloud Dynamic Media Classic).
