...
1. Si aucun composant Dynamic Media n’est disponible, sélectionnez la règle dans la [!UICONTROL Sidekick] pour entrer **[!UICONTROL Conception]** mode .
1. Sélectionner **[!UICONTROL Modifier]** parsys.
1. Sélectionner **[!UICONTROL Dynamic Media]** afin de rendre les composants Dynamic Media disponibles.
...
1. Sélectionner **[!UICONTROL Modifier]** donc le composant s’ouvre.
1. [Modifier le composant](#dynamic-media-component) si nécessaire.
1. Sélectionner **[!UICONTROL OK]** vos modifications sont donc enregistrées.
...
Cette option n’est disponible que si vous affichez des visionneuses d’images, à 360° ou de supports variés. Les paramètres de visionneuse prédéfinis affichés sont intelligents. En d’autres termes, seuls les paramètres prédéfinis de visionneuse pertinents s’affichent.
