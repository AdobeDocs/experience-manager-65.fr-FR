...
description: Découvrez comment déployer Adobe Experience Manager eCommerce avec SAP Commerce Cloud.
...
>[!NOTE]
>
>Cette page contient des liens vers le site web d’Hybris. Pour accéder à certaines pages, vous avez besoin d’un compte pour vous connecter.
...
1. Créez votre catalogue dans votre moteur eCommerce :
   ...
   1. [Configurez la boutique Geometrixx Outdoors](#setup-the-geometrixx-outdoors-store).
...
Les étapes de cette procédure téléchargent et créent le serveur Hybris. Elles effectuent également les configurations initiales requises pour les connexions entre Hybris et cq. L’extension est alors utilisable avec les paramètres par défaut.
