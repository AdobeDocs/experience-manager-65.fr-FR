...
* `db` : nom de la base de donnée Mongo. La valeur par défaut est **Oak** ``. However, new AEM 6 installations use **aem-author** ``comme nom de la base de données par défaut.
