...
| `CQ65DMMigrationTask` | &lt; 6.5 | Différé | Migration des paramètres de catalogue hérités et des paramètres des Cloud Services Dynamic Media depuis **/etc** to **/conf** |
| `CQ65LegacyClientlibsCleanupTask` | &lt; 6.5 | Différé | Nettoyer les clientlibs héritées existantes sous **/etc/clientlibs** |
