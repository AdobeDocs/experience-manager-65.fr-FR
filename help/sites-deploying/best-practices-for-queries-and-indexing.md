...
Si vous souhaitez explorer vos index à l’aide d’un outil comme [Luke](https://code.google.com/archive/p/luke/), vous devez utiliser la console Oak pour vider l’index de la `NodeStore` à un répertoire de système de fichiers. Pour obtenir des instructions sur la façon de procéder, veuillez lire le [Documentation Lucene](https://jackrabbit.apache.org/oak/docs/query/lucene.html).
