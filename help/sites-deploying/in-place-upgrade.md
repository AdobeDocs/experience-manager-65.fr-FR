...
* **Instance mise à niveau :** Si vous mettez à niveau à partir d’une version **plus de 5.6**, vérifiez que vous avez effectué une mise à niveau statique vers AEM 6.0 en suivant la procédure décrite dans la version 6.0 de la documentation de mise à niveau.
