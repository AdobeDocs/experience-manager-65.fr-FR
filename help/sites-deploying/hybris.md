...
>[!NOTE]
>
>Le connecteur pour AEM 6.5 n’est pas prêt.
...
* Votre serveur Hybris, disponible auprès de [Hybris](#configureandbuildthehybrisserver).
...
1. Téléchargez la **hybris Commerce Suite **distribution à partir du site de téléchargement d&#39;hybris.
...
1. **Transférez** le **fichier d’importation** suivant :
   ...
   [Obtenir un fichier](assets/base-store.csv)Pour hybris 5.7, veuillez utiliser ce qui suit :
