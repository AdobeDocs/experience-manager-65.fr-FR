...
1. Sélectionner **[!UICONTROL Créer]** vous pouvez ajouter un profil d’image.
...
1. Sélectionnez le profil d’image à modifier ou à supprimer. Pour le modifier, sélectionnez **[!UICONTROL Modifier le profil d’image]**. Pour le supprimer, sélectionnez **[!UICONTROL Suppression d’un profil d’image]**.
...
1. Sélectionnez l’onglet **[!UICONTROL Profils d’image.]** Dans la **[!UICONTROL Nom du profil]** , sélectionnez le profil, puis sélectionnez **[!UICONTROL Enregistrer et fermer]**. Dans le cas des dossiers auxquels un profil est déjà affecté, le nom du profil est affiché directement sous celui du dossier.
