...
| **[!UICONTROL Nom du serveur original]** | Obligatoire.<br>Ce serveur est utilisé uniquement pour les tests d’assurance qualité. Ne modifiez pas le nom de ce serveur à moins que le support technique d’Adobe ne vous le demande. |
