...
1. Dans Dynamic Media Classic, [configurer un téléchargement et un codage FTP planifiés dans Scene7 (système automatisé) ;](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/uploading-files.html#upload-files-using-via-ftp).
...
1. Dans **[!UICONTROL Cloud Services]**, accédez à la **[!UICONTROL Scene7]** configuration et sélectionnez **[!UICONTROL Modifier]**.
...
Pour mettre à jour la visionneuse et les paramètres prédéfinis de codage pour la vidéo, car ils ont été mis à jour dans Scene7, accédez à la configuration Scene7 dans la configuration du cloud et sélectionnez **[!UICONTROL Mise à jour de la visionneuse et des paramètres prédéfinis de codage]**.
...
1. Sélectionner **[!UICONTROL Télécharger]** pour télécharger une vidéo source Principale. Le téléchargement et le codage vidéo sont terminés une fois que la fonction [!UICONTROL Ressources de mise à jour de gestion des actifs numériques] le workflow est terminé et **[!UICONTROL Publication sur Scene7]** comporte une coche.

   >[!NOTE]
   >
   >La génération des miniatures vidéo prend du temps.

   Faire glisser la vidéo source Principale de la gestion des actifs numériques sur l’accès au composant vidéo *all* Rendus proxy codés Scene7 pour la diffusion.
...
>[!NOTE]
>
>Prêt à l’emploi, le composant vidéo S7 utilise le profil vidéo universel. Vous pouvez toutefois obtenir le lecteur vidéo basé sur HTML5 à utiliser par Experience Manager. Dans Scene7, copiez le code incorporé du lecteur vidéo HTML5 prêt à l’emploi et collez-le dans votre page de Experience Manager.
...
1. Dans le **[!UICONTROL Console de configuration]**, accédez à **[!UICONTROL Outils]** > **[!UICONTROL DAM]** > **[!UICONTROL Profils vidéo]** dans l’arborescence de navigation.
...
1. Pour les navigateurs qui ne prennent pas en charge HTML5, le composant vidéo vous permet de configurer un Flash de secours. Ouvrez la boîte de dialogue de conception des composants vidéo et modifiez le **[!UICONTROL Flash]** . Configurez les paramètres du lecteur Flash et attribuez un profil de secours au lecteur Flash.
