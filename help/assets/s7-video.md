...
1. Téléchargez la ressource vidéo sur Adobe DAM et codez et publiez automatiquement sur Dynamic Media Classic.
...
## Téléchargement de votre vidéo source principale vers Scene7 à partir de Adobe DAM {#uploading-your-master-video}
...
>[!NOTE]
>
>Prêt à l’emploi, le composant vidéo S7 utilise le profil vidéo universel. Vous pouvez toutefois obtenir le lecteur vidéo basé sur HTML5 pour AEM en procédant de l’une des manières suivantes dans Scene7 : copiez le code incorporé du lecteur vidéo HTML5 prêt à l’emploi et collez-le dans votre page AEM.
...
1. Pour les navigateurs qui ne prennent pas en charge HTML5, le composant vidéo permet de configurer une reprise Flash. Open the video components design dialog box and change to the **[!UICONTROL Flash]** tab. Configurez les paramètres du lecteur Flash et affectez un profil de secours au lecteur Flash.
