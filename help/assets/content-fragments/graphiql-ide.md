...
>[!NOTE]
>Vous devez avoir [configuré vos points de fin](/help/assets/content-fragments/graphql-api-content-fragments.md#graphql-aem-endpoint) dans le [navigateur de configuration](/help/assets/content-fragments/content-fragments-configuration-browser.md) avant d’utiliser l’IDE GraphiQL.
...
* créer et accéder aux **[Requêtes persistantes](/help/assets/content-fragments/persisted-queries.md)** ;
...
Sélectionnez la requête à mettre à jour dans la liste du panneau des **[Requêtes persistantes](/help/assets/content-fragments/persisted-queries.md)** (à l’extrême gauche).
...
L’IDE GraphiQL vous permet également de gérer vos [variables de requête](/help/assets/content-fragments/graphql-api-content-fragments.md#graphql-variables).
...
Après avoir développé et testé votre requête persistante avec GraphiQL, l’objectif final est de [la transférer vers votre environnement de production](/help/assets/content-fragments/persisted-queries.md#transfer-persisted-query-production) pour qu’elle soit utilisée par vos applications.
