...
description: Découvrez comment automatiser les workflows afin de traduire des ressources, notamment des fichiers binaires, des métadonnées et des balises dans plusieurs langues.
contentOwner: AG
...
Si votre fournisseur de services de traduction ne fournit pas de connecteur à intégrer à [!DNL Experience Manager], utilisez un [autre processus](/help/sites-administering/tc-manage.md#exporting-a-translation-job).
