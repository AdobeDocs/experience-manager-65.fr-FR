---
title: Application de paramètres d’image prédéfinis de média dynamique
...
# Application de paramètres d’image prédéfinis de média dynamique {#applying-image-presets}
...
**Pour appliquer les paramètres d’image prédéfinis de média dynamique**
