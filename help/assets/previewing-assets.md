...
* [Application de paramètres prédéfinis de visionneuse](/help/assets/viewer-presets.md)

>[!NOTE]
>
>Lorsque vous vous trouvez sur une page web (Sites) dans Experience Manager, vous ne pouvez pas prévisualiser les ressources en mode d’**édition**. Accédez au mode Aperçu en cliquant sur **[!UICONTROL Aperçu]** dans le coin supérieur droit de la page.
...
1. De **[!UICONTROL Adobe Experience Manager]**, sur le **[!UICONTROL Navigation]** page, sélectionnez **[!UICONTROL Ressources]**, puis **[!UICONTROL Fichiers]** pour accéder aux ressources.
1. Dans le coin supérieur droit de la page, dans la liste déroulante **[!UICONTROL Afficher]**, sélectionnez **[!UICONTROL Mode Liste]**.
...
1. Selon le type de ressource sur lequel vous avez cliqué, procédez de l’une des manières suivantes :
   ...
   <table>
    <tbody>
      ...
      <td><strong>Est-il possible de prévisualiser une ressource dans une visionneuse ?</strong></td>
      <td> </td>
      </tr>
      <tr>
      <td><p>3D</p> </td>
      ...
      <li>Sélectionner <strong>Réinitialiser</strong> si vous souhaitez rétablir l’image sur le zoom d’origine.</li>
      <li>Sélectionner <strong>Plein écran</strong> pour agrandir la visionneuse sur l’appareil d’affichage.</li>
      </ul>
      ...
      <li><p><strong>Zoom sur la caméra</strong> - Zoomer l’appareil photo afin que vous puissiez vous déplacer dans et hors des zones de la scène 3D.</p> Souris : effectuez un défilement à l’aide de la roulette </p> Écran tactile : effectuez un pincement du doigt</p></li>
      <li><p><strong>Recentrez votre appareil photo</strong> : faites tourner votre angle de vue autour de la scène et des objets 3D.</p> Souris : double-cliquez </p> Écran tactile : Double-appuyez</li></ul></td>
      </tr>
      <tr>
      <td><p>Image</p> </td>
      <td>Oui</td>
      ...
      <ul>
      <li>En haut à gauche de la page, cliquez sur l’icône pour afficher la liste déroulante. Sélectionnez <strong>Visionneuses</strong> dans la liste, puis sélectionnez une visionneuse à appliquer à la ressource.</li>
      </ul> <p>Utilisez la variable <strong>+</strong> et <strong>-</strong> pour augmenter ou diminuer le zoom de l’image sélectionnée. Sélectionner <strong>Réinitialiser</strong> si vous souhaitez rétablir l’image sur le zoom d’origine.<br /> Si vous utilisez un écran tactile, appuyez deux fois sur l’image pour effectuer un zoom avant par étapes. Lorsque vous avez atteint le zoom maximal, appuyez à nouveau deux fois sur l’image pour réinitialiser le zoom. Placez-vous sur l’image et faites glisser pour effectuer un panoramique.</p> </td>
      </tr>
      <tr>
...
1. Dans le dossier , appuyez sur la touche `<Tab>` touche ou touche fléchée du clavier pour sélectionner la ressource.

1. Press `<Enter>` vous pouvez donc ouvrir la ressource sélectionnée en mode Aperçu.

1. Procédez de l’une des manières suivantes :

   * Pour effectuer un zoom avant, appuyez sur `<Tab>` pour déplacer la mise au point sur l’icône de zoom avant (+), puis appuyez sur `<Enter>` un ou plusieurs zoom avant incrémentiel.
   ...
   * Pour déplacer la vue d’un *zoomé* ressource horizontalement ou verticalement, appuyez sur les touches fléchées correspondantes.
   * Press `<Shift>` + `<Tab>` vous pouvez ainsi réinitialiser l’affichage et réactiver la mise au point sur la ressource.
