...
## Aperçu des ressources à l’aide d’un clavier {#keyboard-navigation-asset-preview}
...
1. Appuyez sur `<Enter>` pour ouvrir la ressource sélectionnée en mode d’aperçu.
