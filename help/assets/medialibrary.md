...
# Ressources AEM versus Bibliothèque multimédia AEM {#aem-assets-vs-aem-medialibrary}
...
* toutes les étapes du processus liées à la gestion des ressources numériques, à savoir l’importation des ressources AEM, la suppression des ressources AEM, la gestion des sous-ressources AEM Assets, l’extraction des métadonnées AEM Assets.
* bibliothèques incluant &quot;dam&quot; im package space.
...
Oui, le prédicat de catégorie fait partie des ressources AEM et nécessite une licence AEM Assets.
