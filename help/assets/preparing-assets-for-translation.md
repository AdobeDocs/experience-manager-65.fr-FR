...
Dans [!DNL Adobe Experience Manager Assets], les ressources multilingues sont incluses dans les dossiers, où chaque dossier contient les ressources dans une langue différente.
...
1. Dans la [!DNL Assets] console, cliquez sur **[!UICONTROL Créer]** et choisissez **[!UICONTROL Dossier]** dans le menu.

   ![Créer un dossier](assets/Create-folder.png)

1. Dans le **[!UICONTROL Nom]** saisissez le code pays au format de `<language-code>`.

   ![Ajout de code de langue dans le dossier](assets/Add-language-code-in-folder.png)

1. Cliquez sur **[!UICONTROL Créer]**. La racine de langue est créée dans le [!DNL Assets] console.

## Affichage des racines de langue {#viewing-language-roots}

[!DNL Experience Manager] fournit une **[!UICONTROL Références]** qui affiche la liste des racines de langue créées dans [!DNL Assets].

1. Dans le [!DNL Assets] , sélectionnez la Principale de langue pour laquelle vous souhaitez créer des copies de langue.
1. Dans le rail de gauche, sélectionnez **[!UICONTROL Références]** pour ouvrir la [!UICONTROL Référence] volet.

   ![chlimage_1-122](assets/chlimage_1-122.png)

1. Dans le volet Références , cliquez sur **[!UICONTROL Copies de langue]**. Le [!UICONTROL Copies de langue] affiche les copies de langue des ressources.
