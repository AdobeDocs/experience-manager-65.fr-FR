...
>[!NOTE]
>
>Cette documentation décrit les fonctionnalités de Dynamic Media, qui sont directement intégrées à Adobe Experience Manager. Si vous utilisez Dynamic Media Classic intégré à Experience Manager, consultez la [documentation sur l’intégration de Dynamic Media Classic](/help/sites-administering/scene7.md).
>
>Voir [Scénario à double utilisation](/help/sites-administering/scene7.md#dual-use-scenario) pour connaître les cas où vous souhaitez utiliser Experience Manager intégré à Dynamic Media Classic avec Dynamic Media.
