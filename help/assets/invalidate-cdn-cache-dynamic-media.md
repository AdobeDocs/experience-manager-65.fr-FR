...
>[!IMPORTANT]
>
>Les étapes suivantes s’appliquent uniquement au mode Dynamic Media - Scene7 dans AEM 6.5, Service Pack 6 (AEM 6.5.6) ou version ultérieure. Cette fonction d’invalidation CDN nécessite également que vous utilisiez le CDN prêt à l’emploi fourni avec AEM Dynamic Media ; aucun autre CDN personnalisé n’est pris en charge.<br>Si vous utilisez Dynamic Media dans AEM 6.5, Service Pack 5 (AEM 6.5.5) ou version antérieure, suivez les étapes décrites dans la section  [Invalidation du cache CDN par le biais de Dynamic Media Classic.](/help/assets/invalidate-cdn-cache-dm-classic.md)
...
1. Dans AEM 6.5.6 ou version ultérieure, appuyez sur **[!UICONTROL Outils > Ressources > Invalidation CDN.]**
...
1. Sur la page **[!UICONTROL Invalidation CDN - Confirmer]**, dans la zone **[!UICONTROL URLs]** liste, vous verrez une liste d’une ou de plusieurs URL générées à partir du modèle d’invalidation CDN que vous avez créé précédemment et des actifs que vous venez d’ajouter.
...
| Erreur | Explication |
| --- | --- |
| *Échec de la récupération des URL de la ou des ressources sélectionnées.* | Se produit si l&#39;un des scénarios suivants est satisfait : <br>- Une configuration Dynamic Media est introuvable.<br>- Il existe une exception lors de la récupération d&#39;un utilisateur de service par l&#39;intermédiaire duquel la configuration Dynamic Media est lue.<br>- Le serveur de publication ou la racine de société utilisée pour former les URL est absent de la configuration Dynamic Media. |
...
| *Aucune URL entrée à valider.* | Se produit si aucune URL n&#39;est présente dans la page **[!UICONTROL Invalidation CDN - Confirmer]** et que vous appuyez sur **[!UICONTROL Envoyer.]** |
