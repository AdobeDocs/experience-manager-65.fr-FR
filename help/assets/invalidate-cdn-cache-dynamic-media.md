...
# Invalidation du cache CDN via Dynamic Media {#invalidating-cdn-cache-for-dm-assets}
...
1. Dans Experience Manager 6.5.6 ou version ultérieure, accédez à **[!UICONTROL Outils]** > **[!UICONTROL Ressources]** > **[!UICONTROL Invalidation du réseau de diffusion de contenu]**.
...
1. Dans le coin supérieur droit de la page **[!UICONTROL Modèle d’invalidation du réseau de diffusion de contenu]**, sélectionnez **[!UICONTROL Enregistrer]**, puis sélectionnez **[!UICONTROL OK]**.<br>

   *Partie 2 de 2 : définition des options d’invalidation du réseau CDN*
   <br>

1. Dans Experience Manager en tant que Cloud Service, sélectionnez **[!UICONTROL Outils]** > **[!UICONTROL Ressources]** > **[!UICONTROL Invalidation du réseau de diffusion de contenu]**.
...
1. Sur la page **[!UICONTROL Invalidation du réseau de diffusion de contenu - Confirmer]**, dans la zone de liste **[!UICONTROL URL]**, vous pouvez voir une liste d’une ou de plusieurs URL générées à partir du modèle d’invalidation du réseau de diffusion de contenu que vous avez créé précédemment et des ressources que vous venez d’ajouter.
   ...
   Si nécessaire, sélectionnez **X** à droite d’une URL pour la supprimer du processus d’invalidation.

1. Près du coin supérieur droit de la page, sélectionnez **[!UICONTROL Submit]** pour lancer le processus d’invalidation du réseau de diffusion de contenu.
...
| *Aucune URL entrée pour être invalidée.* | Se produit si aucune URL n’est présente dans la page **[!UICONTROL Invalidation du réseau de diffusion de contenu - Confirmer]** et que vous sélectionnez **[!UICONTROL Envoyer]**. |
