...
description: Découvrez comment utiliser les bannières de carrousel dans Contenu multimédia dynamique
...
La création et la modification du contenu présenté sur les bannières publicitaires peuvent prendre beaucoup de temps et réduire votre capacité à publier rapidement du contenu nouveau ou plus ciblé. Les bannières de carrousel vous permettent de créer ou de modifier rapidement des bannières rotatives, d’ajouter des éléments interactifs tels que des zones réactives qui renvoient vers des détails de produit ou des ressources connexes, et de les diffuser sur n’importe quel écran, ce qui vous permet d’apporter plus rapidement du contenu promotionnel au marché.
...
>[!NOTE]
>
>Les utilisateurs non administrateurs doivent être ajoutés au groupe **[!UICONTROL dam-users]** de façon à pouvoir créer ou modifier des bannières de carrousel. If you are having trouble creating or editing, please see your system administrator who can add you to the **d[!UICONTROL am-users ]**group.
...
1. [Créez un ensemble de carrousels](#creating-carousel-sets).
   ...
   To create a Carousel Set in Assets, tap **[!UICONTROL Create]**, then select **[!UICONTROL Carousel Sets]**. Add assets to slides and tap **[!UICONTROL Save]**. Vous pouvez également modifier l’apparence et le comportement du carrousel directement dans l’éditeur.
...
1. [Publication des bannières de carrousel.](#publishing-carousel-banners)
   ...
   Vous publiez un ensemble de carrousel comme vous le feriez pour d’autres ressources. In Assets, navigate to the Carousel Set and select it and tap **[!UICONTROL Publish]**. La publication d’un ensemble de carrousel active l’URL et la chaîne incorporée.

1. Utilisez l’une des méthodes suivantes :

   * [Ajout d’une bannière de carrousel à votre page Web
      ](#adding-a-carousel-banner-to-your-website-page)Vous pouvez ajouter l’URL de la bannière du carrousel ou le code incorporé que vous avez copié sur la page du site Web.
   ...
   * [Ajout d’une bannière de carrousel à votre site Web dans AEM
      ](/help/assets/adding-dynamic-media-assets-to-pages.md)Si vous êtes un client AEM Sites, vous pouvez ajouter le carrousel défini directement à la page dans AEM, à l’aide du composant Interactive Media.


If you need to edit Carousel Sets, see [editing Carousel Sets.](#editing-carousel-sets) En outre, vous pouvez afficher et modifier les propriétés [de la visionneuse de](https://helpx.adobe.com/experience-manager/6-5/help/assets/managing-assets-touch-ui.md#editingproperties)carrousel.
...
* L’utilisateur active un élément d’interface utilisateur sur le site web. Par exemple, en appuyant sur un bouton Affichage **[!UICONTROL rapide]** .
...
* Pour afficher toutes les requêtes HTTP sortantes dans Google Chrome, appuyez sur la touche F12 (Windows) ou Commande-Option-I (Mac) pour ouvrir le panneau Outils de développement, puis appuyez sur l’onglet Réseau.
...
Pour transférer des bannières d’image, reportez-vous à la section [Téléchargement de ressources](/help/assets/managing-assets-touch-ui.md).
...
**Pour créer une visionneuse de carrousels**
...
1. Dans la page de l’éditeur de bannière de carrousel, appuyez sur **[!UICONTROL Appuyer pour ouvrir le sélecteur de ressources]** pour sélectionner l’image de votre première diapositive.
   ...
   * Près du milieu de la page, appuyez sur **[!UICONTROL Appuyer pour ouvrir le sélecteur de ressources]**.
   Appuyez pour sélectionner les ressources à inclure dans votre ensemble de carrousel. Les ressources sélectionnées sont cochées. When you are finished, near the upper-right corner of the page, tap **[!UICONTROL Select**.
...
1. Vous pouvez modifier l’apparence et le comportement des ensembles de carrousels en appuyant ou en cliquant sur les onglets Comportement et Apparence et en apportant des ajustements à l’apparence de votre bannière de carrousel et au comportement des éléments spécifiques. Pour plus d’informations sur l’utilisation de l’éditeur de visionneuses, reportez-vous à la section [Gestion des paramètres prédéfinis de visionneuse](/help/assets/viewer-presets.md).
   ...
   >
   >
   >Pour des instructions détaillées et plus d’informations sur l’éditeur de visionneuses, voir [Considérations spécifiques aux bannières de carrousel](/help/assets/viewer-presets.md#specialconsiderationsforcreatingacarouselbannerviewerpreset).
...
>[!NOTE]
>
>N’oubliez pas que les outils de partage sur les réseaux sociaux de la bannière de carrousel ne sont pas pris en charge lorsque vous incorporez la visionneuse dans un fragment d’expérience.
...
À mesure que vous ajoutez des zones réactives ou des zones cliquables à une image, pensez à enregistrer votre travail. Les options Annuler et Rétablir, situées dans l’angle supérieur droit de la page, sont prises en charge lors de la session de création/modification en cours.

Lorsque vous avez fini de créer votre bannière de carrousel, vous pouvez éventuellement utiliser la fonction Aperçu pour afficher une représentation de l’aspect de votre bannière de carrousel pour les clients.

Voir [(Facultatif) Aperçu des bannières de carrousel.](#optional-previewing-carousel-banners)

>[!NOTE]
>
>When you add hotspots to an image in an [Interactive Image](/help/assets/interactive-images.md) or a Carousel Banner, the hotspot information is stored in the same metadata location—relative to the image&#39;s location&amp;mdashregardless of whether it is an Interactive Image or a Carousel Banner. Cette fonctionnalité vous permet de réutiliser facilement la même image (ainsi que ses données de zone réactive définies) dans l’une ou l’autre visionneuse.
...
1. Select the carousel set and tap **[!UICONTROL Edit]**. L’éditeur de visionneuses de carrousel s’affiche.
...
1. Effectuez l’une des opérations suivantes :
   ...
   * Pour les zoones cliquables : sur l’image, cliquez puis faites glisser le pointeur depuis le coin supérieur gauche vers le coin inférieur droit pour créer la zone cliquable. Vous pouvez ajuster la taille de la zone cliquable en faisant glisser les coins.
...
1. Effectuez l’une des actions disponibles sur l’onglet **[!UICONTROL Actions]** :
   ...
   * Appuyez sur **[!UICONTROL Aperçu rapide]**.
      ...
      * Si vous êtes un client des sites AEM et du commerce électronique, appuyez sur l’icône Sélecteur de produits (loupe) pour ouvrir la page Sélectionner un produit. Appuyez sur le produit que vous souhaitez utiliser, puis cochez la coche dans le coin supérieur droit de la page pour revenir à l’éditeur de bannière de carrousel.
      * Si vous n’êtes pas un client AEM Sites ou e-Commerce
         ...
         * (Optional) If there are other variables within the quick view that you need to use to further identify a product, tap **[!UICONTROL Add Generic Variable]**. In the text field, specify an additional variable. Par exemple, category = Homme est une variable ajoutée.

         * Pour plus d’informations, reportez-vous à la section [Utilisation de sélecteurs](/help/assets/working-with-selectors.md).
   * Appuyez sur **[!UICONTROL Lien hypertexte]**.

      * Si vous êtes un client AEM Sites, appuyez sur l’icône Sélecteur de site (dossier) pour accéder à une URL.
         >[!NOTE]
   ...
   * Appuyez sur **[!UICONTROL Fragment d’expérience]**.
      ...
      * Si vous êtes un client AEM Sites, appuyez sur l’icône de recherche (loupe) pour ouvrir la page Fragment d’expérience. Appuyez ou cliquez sur le fragment d’expérience à utiliser, puis appuyez sur Sélectionner dans le coin supérieur droit de la page pour revenir à la page Gestion des zones réactives.
...
* Ajouter des diapositives à l’ensemble de carrousel. See also [Working with Selectors](/help/assets/working-with-selectors.md).
...
* Ajouter ou modifier des zones réactives et des zones cliquables. See also [Working with Selectors](/help/assets/working-with-selectors.md).

**Pour modifier une visionneuse de carrousels**
...
Vous pouvez utiliser la fonction Aperçu pour voir à quoi ressemblera votre bannière de carrousel pour les clients et pour tester les zones réactives des bannières de carrousel et les zones cliquables afin de vous assurer qu’elles se comportent comme prévu.

Lorsque vous êtes satisfait de la bannière de carrousel, vous pouvez la publier.
Reportez-vous à la section [Incorporation de la visionneuse de vidéos ou d’images dans une page web](/help/assets/embed-code.md).
...
>[!NOTE]
Si vous êtes un client AEM Sites, vous pouvez ajouter la bannière de carrousel directement dans votre page en faisant glisser le composant Interactive Media dans votre page. Reportez-vous à la section [Ajout de ressources Dynamic Media aux pages.](/help/assets/adding-dynamic-media-assets-to-pages.md)
...
## Utilisation des aperçus rapides pour créer des fenêtres contextuelles personnalisées {#using-quickviews-to-create-custom-pop-ups}
